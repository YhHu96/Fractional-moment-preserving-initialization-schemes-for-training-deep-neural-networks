...
class simpleNet(nn.Module):
    def __init__(self, n_hidden_2, out_dim):
        ...
        # We choose the s = 0.8 for ReLU activation
        
        self.conv1 = nn.Conv2d(3, 6, 5)
        self.pool = nn.MaxPool2d(2, 2)
        self.conv2 = nn.Conv2d(6, 16, 5)
        self.layer1 = nn.Linear(16 * 5 * 5, 64)
        yuanhan_normal_(self.layer1.weight,nonlinearity='relu', s=0.8)
        self.layer2 = nn.Linear(64, n_hidden_2)
        yuanhan_normal_(self.layer2.weight,nonlinearity='relu', s=0.8)
        self.layer3 = nn.Linear(n_hidden_2, n_hidden_2)
        yuanhan_normal_(self.layer3.weight,nonlinearity='relu', s=0.8)
        self.layer4 = nn.Linear(n_hidden_2, n_hidden_2)
        yuanhan_normal_(self.layer4.weight,nonlinearity='relu', s=0.8)
        self.layer5 = nn.Linear(n_hidden_2, n_hidden_2)
        yuanhan_normal_(self.layer5.weight,nonlinearity='relu', s=0.8)
        self.layer6 = nn.Linear(n_hidden_2, n_hidden_2)
        yuanhan_normal_(self.layer6.weight,nonlinearity='relu', s=0.8)
        self.layer7 = nn.Linear(n_hidden_2, n_hidden_2)
        yuanhan_normal_(self.layer7.weight,nonlinearity='relu', s=0.8)
        self.layer8 = nn.Linear(n_hidden_2, n_hidden_2)
        yuanhan_normal_(self.layer8.weight,nonlinearity='relu', s=0.8)
        self.layer9 = nn.Linear(n_hidden_2, n_hidden_2)
        yuanhan_normal_(self.layer9.weight,nonlinearity='relu', s=0.8)
        self.layer10 = nn.Linear(n_hidden_2, n_hidden_2)
        yuanhan_normal_(self.layer10.weight,nonlinearity='relu', s=0.8)
        self.layer11 = nn.Linear(n_hidden_2, n_hidden_2)
        yuanhan_normal_(self.layer11.weight,nonlinearity='relu', s=0.8)
        self.layer12 = nn.Linear(n_hidden_2, n_hidden_2)
        yuanhan_normal_(self.layer12.weight,nonlinearity='relu', s=0.8)
        self.layer13 = nn.Linear(n_hidden_2, n_hidden_2)
        yuanhan_normal_(self.layer13.weight,nonlinearity='relu', s=0.8)
        self.layer14 = nn.Linear(n_hidden_2, n_hidden_2)
        yuanhan_normal_(self.layer14.weight,nonlinearity='relu', s=0.8)
        self.layer15 = nn.Linear(n_hidden_2, n_hidden_2)
        yuanhan_normal_(self.layer15.weight,nonlinearity='relu', s=0.8)
        self.layer16 = nn.Linear(n_hidden_2, n_hidden_2)
        yuanhan_normal_(self.layer16.weight,nonlinearity='relu', s=0.8)
        self.layer17 = nn.Linear(n_hidden_2, n_hidden_2)
        yuanhan_normal_(self.layer17.weight,nonlinearity='relu', s=0.8)
        self.layer18 = nn.Linear(n_hidden_2, n_hidden_2)
        yuanhan_normal_(self.layer18.weight,nonlinearity='relu', s=0.8)
        self.layer19 = nn.Linear(n_hidden_2, n_hidden_2)
        yuanhan_normal_(self.layer19.weight,nonlinearity='relu', s=0.8)
        self.layer20 = nn.Linear(n_hidden_2, out_dim)
        yuanhan_normal_(self.layer20.weight,nonlinearity='relu', s=0.8)
        ...
        self.layer5 = nn.Linear(n_hidden_2, n_hidden_2)
        nn.init.kaiming_normal_(self.layer5.weight,nonlinearity='relu')
        self.layer6 = nn.Linear(n_hidden_2, n_hidden_2)
        nn.init.kaiming_normal_(self.layer6.weight,nonlinearity='relu')
        self.layer7 = nn.Linear(n_hidden_2, n_hidden_2)
        nn.init.kaiming_normal_(self.layer7.weight,nonlinearity='relu')
        self.layer8 = nn.Linear(n_hidden_2, n_hidden_2)
        nn.init.kaiming_normal_(self.layer8.weight,nonlinearity='relu')
        self.layer9 = nn.Linear(n_hidden_2, n_hidden_2)
        nn.init.kaiming_normal_(self.layer9.weight,nonlinearity='relu')
        self.layer10 = nn.Linear(n_hidden_2, n_hidden_2)
        nn.init.kaiming_normal_(self.layer10.weight,nonlinearity='relu')
        self.layer11 = nn.Linear(n_hidden_2, n_hidden_2)
        nn.init.kaiming_normal_(self.layer11.weight,nonlinearity='relu')
        self.layer12 = nn.Linear(n_hidden_2, n_hidden_2)
        nn.init.kaiming_normal_(self.layer12.weight,nonlinearity='relu')
        self.layer13 = nn.Linear(n_hidden_2, n_hidden_2)
        nn.init.kaiming_normal_(self.layer13.weight,nonlinearity='relu')
        self.layer14 = nn.Linear(n_hidden_2, n_hidden_2)
        nn.init.kaiming_normal_(self.layer14.weight,nonlinearity='relu')
        self.layer15 = nn.Linear(n_hidden_2, n_hidden_2)
        nn.init.kaiming_normal_(self.layer15.weight,nonlinearity='relu')
        self.layer16 = nn.Linear(n_hidden_2, n_hidden_2)
        nn.init.kaiming_normal_(self.layer16.weight,nonlinearity='relu')
        self.layer17 = nn.Linear(n_hidden_2, n_hidden_2)
        nn.init.kaiming_normal_(self.layer17.weight,nonlinearity='relu')
        self.layer18 = nn.Linear(n_hidden_2, n_hidden_2)
        nn.init.kaiming_normal_(self.layer18.weight,nonlinearity='relu')
        self.layer19 = nn.Linear(n_hidden_2, n_hidden_2)
        nn.init.kaiming_normal_(self.layer19.weight,nonlinearity='relu')
        self.layer20 = nn.Linear(n_hidden_2, out_dim)
        nn.init.kaiming_normal_(self.layer20.weight,nonlinearity='relu')
        '''
